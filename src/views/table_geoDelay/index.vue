<template>
    <div class="app-container">  
        ...
        <el-table-column prop="geo_place_id" label="地理位置id"></el-table-column>
        <!--<el-table-column prop="geographic_place_name" label="地理位置名" filter="{type: 'text', method: filterHandler}"></el-table-column>-->
        <el-table-column prop="delay" label="延迟值" sortable></el-table-column>
      </el-table>
